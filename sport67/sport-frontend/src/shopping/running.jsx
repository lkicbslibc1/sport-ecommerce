...
export default function Running({ onViewChange }) {
      ...
      <main className="max-w-max-width mx-auto px-6 lg:px-12 py-base pt-28">
        ...
        <div class="mb-10">
          ...
          <p className="text-on-surface-variant max-w-xl mt-4 font-body-lg font-light leading-relaxed">
            Engineered for speed. Designed for endurance. Explore our latest high-performance footwear and apparel for every runner.
          </p>
        </div>
