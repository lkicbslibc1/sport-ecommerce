...
| UAT-C04 | ค้นหาสินค้า | ✅ ผ่าน | ปัญหาเกี่ยวกับหน้าจอและการใช้งาน | -เมื่อ filter ตามสี ภาพสินค้าที่แสดงควรแสดงผลตามที่เลือก (ปัจจุบันเป็น default) -ควรเรียงจากrecommend (ปัจจุบัน default)|
| UAT-C05 | ดูรายละเอียดสินค้า | ✅ ผ่าน | - | - |
| UAT-C06 | ใส่ตะกร้า | ✅ ผ่าน | - | - |
