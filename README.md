...
|---|---|
| **อาชีพ** | พนักงานออฟฟิศ |
| **พฤติกรรม** | ชื่นชอบการเล่นกีฬาและออกกำลังกายหลังเลิกงาน มักจะหาข้อมูลสเปกอุปกรณ์กีฬาผ่านอินเทอร์เน็ตก่อนตัดสินใจซื้อเสมอ |
| **เป้าหมาย** | ต้องการซื้อรองเท้าวิ่งและอุปกรณ์ฟิตเนสใหม่ แต่ต้องการความสะดวกรวดเร็ว สามารถกดสั่งซื้อและเช็คสถานะการส่งของได้ตลอดเวลาโดยไม่ต้องทักแชทถามแอดมิน |
| **ปัญหาที่พบ** | • ไม่มีเวลาไปเดินเลือกซื้อที่หน้าร้านเพราะเลิกงานดึก (ร้านปิดแล้ว)<br>• เคยหงุดหงิดกับการสั่งของร้านอื่นแล้วโอนเงินไปแล้ว แต่เพิ่งมาทราบทีหลังว่า "ของหมดสต๊อก"<br>• อยากได้หน้าเว็บที่ดูสะอาดตา ใช้งานง่าย ไม่ซับซ้อน |

**Role 2 : Employee**
| ชื่อ | น้องเมย์ (อายุ 24 ปี) |
|---|---|
| **อาชีพ** | พนักงานฝ่ายปฏิบัติการร้านค้า |
| **พฤติกรรม** | รับหน้าที่ดูแลออเดอร์รายวัน จัดเตรียมสินค้าเพื่อจัดส่ง และต้องคอยตอบคำถามลูกค้าว่า "ของส่งหรือยัง?" |
| **เป้าหมาย** | ต้องการระบบหลังบ้านที่ดูรายการคำสั่งซื้อใหม่ได้ง่ายๆ และกดอัปเดตสถานะการจัดส่ง (เช่น กำลังเตรียมจัดส่ง) ได้อย่างรวดเร็ว |
| **ปัญหาที่พบ** | • ระบบจดมือหรือใช้ Excel แบบเก่าทำให้เกิดข้อผิดพลาดบ่อย (ออเดอร์ตกหล่น)<br>• การเดินไปเช็คสต๊อกหลังร้านทุกครั้งที่มีคนสั่งซื้อทำให้เสียเวลาทำงานมาก |

**Role 3 : Manager**
| ชื่อ | คุณสมเกียรติ (อายุ 45 ปี) |
|---|---|
| **อาชีพ** | เจ้าของร้านจำหน่ายอุปกรณ์กีฬา |
| **พฤติกรรม** | ไม่ค่อยได้ลงมาดูแลการแพ็คของเอง แต่เน้นการบริหารภาพรวม ดูยอดขาย และวางแผนสั่งซื้อสินค้าเข้ามาเติมในโกดัง |
| **เป้าหมาย** | ต้องการระบบหลังบ้านที่ดูรายการคำสั่งซื้อใหม่ได้ง่ายๆ และกดอัปเดตสถานะการจัดส่ง (เช่น กำลังเตรียมจัดส่ง) ได้อย่างรวดเร็ว |
| **ปัญหาที่พบ** | • ไม่รู้ตัวเลขสต๊อกที่แท้จริง ทำให้บางครั้งสั่งของมาดองไว้เยอะเกินไป หรือบางทีของขายดีก็ขาดสต๊อกโดยไม่รู้ตัว (ต้องการระบบแจ้งเตือน Low Stock)<br>• ต้องการควบคุมสิทธิ์พนักงาน เพื่อความปลอดภัยของข้อมูลลูกค้าและบัญชีของร้าน |

---

### ออกแบบ UAT Test Case
โครงงาน : sport67
...
| UAT-C03 | ดูหน้าแรก | ✅ ผ่าน | - | - |
| UAT-C04 | ค้นหาสินค้า | ✅ ผ่าน | ระบบทำงานไม่ตรงตามความต้องการ | เมื่อ filter ตามสี ภาพสินค้าที่แสดงควรแสดงผลตามที่เลือก (ปัจจุบันเป็น default) |
| UAT-C05 | ดูรายละเอียดสินค้า | ✅ ผ่าน | - | - |
| UAT-C06 | ใส่ตะกร้า | ✅ ผ่าน | ระบบทำงานไม่ตรงตามความต้องการ | modal ใส่ตะกร้ายังไม่สวย |
| UAT-C07 | ชำระเงิน | ✅ ผ่าน | - | - |
| UAT-C08 | ติดตามสถานะคำสั่งซื้อ | ✅ ผ่าน | - | - |
| UAT-C09 | รีวิวสินค้า | ✅ ผ่าน | - | - |
| UAT-C10 | ดูประวัติคำสั่งซื้อ | ✅ ผ่าน | - | - |
| UAT-C11 | จัดการโปรไฟล์ | ✅ ผ่าน | - | - |

**Persona : Employee**
| รหัสทดสอบ | รายการทดสอบ | สถานะการทดสอบ | ปัญหา/ข้อผิดพลาด | รายละเอียดของปัญหา |
|---|---|---|---|---|
| UAT-E01 | เข้าสู่ระบบ | ✅ ผ่าน | - | - |
| UAT-E02 | เช็คสต็อกสินค้า | ✅ ผ่าน | - | - |
| UAT-E03 | ดูรายการคำสั่งซื้อ | ✅ ผ่าน | - | - |
| UAT-E04 | ค้นหาสินค้า | ✅ ผ่าน | ระบบทำงานไม่ตรงตามความต้องการ | ควรเพิ่มให้มี filter order ที่ยังไม่ delivered |
| UAT-E05 | อัปเดตสถานะคำสั่งซื้อ | ✅ ผ่าน | - | - |
| UAT-E06 | การแจ้งเตือน | ✅ ผ่าน | - | - |

**Persona : Manager**
| รหัสทดสอบ | รายการทดสอบ | สถานะการทดสอบ | ปัญหา/ข้อผิดพลาด | รายละเอียดของปัญหา |
|---|---|---|---|---|
| UAT-M01 | เข้าสู่ระบบ | ✅ ผ่าน | - | - |
| UAT-M02 | ดูแดชบอร์ดภาพรวมร้านค้า | ✅ ผ่าน | - | - |
| UAT-M03 | เพิ่มบัญชีพนักงาน / ระงับบัญชี | ✅ ผ่าน | - | - |
| UAT-M04 | เพิ่ม ลบ แก้ไขข้อมูลสินค้า | ✅ ผ่าน | - | - |
| UAT-M05 | ดูประวัติคำสั่งซื้อ | ✅ ผ่าน | - | - |
| UAT-M06 | ดูรายการคำสั่งซื้อ | ✅ ผ่าน | - | - |
| UAT-M07 | ดูประวัติลูกค้า | ✅ ผ่าน | - | - |
| UAT-M08 | เช็คสต็อกสินค้า | ✅ ผ่าน | - | - |
| UAT-M09 | การแจ้งเตือน | ✅ ผ่าน | - | - |
...
ผ่าน = 26 รายการ, ไม่ผ่าน = 0 รายการ คิดเป็น **100%** ที่ผ่านการทดสอบ 
*(ผลจากการทดสอบพบว่าระบบพื้นฐานทั้งหมดสามารถใช้งานได้ และไม่พบปัญหาใดๆ ร้ายแรง)*
